...
#pragma region Temp lights
	...
	pointLights[0]->lightPosition = DirectX::XMFLOAT4(-40.0f, 20.0f, 0.0f, 1.0f); //Pos
	pointLights[0]->lightLookAt = DirectX::XMFLOAT4(-40.0f, 0.0f, 0.0f, 1.0f);	//Direct
	...
	pointLights[0]->lightRange = 50.0f;
	...
	pointLights[0]->attenuation = 0.02;
	...
	this->dirLights[0]->intensity = 0.1;
