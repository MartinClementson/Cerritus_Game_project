...
void ShadowBuffer::ShadowSetToRead(ID3D11RenderTargetView* newTarget)
{
	this->gDeviceContext->OMSetRenderTargets(1, &newTarget, NULL);
	this->gDeviceContext->PSSetShaderResources(1, SHADOWMAPAMOUNT, &this->shadowShaderResourceView);
}
